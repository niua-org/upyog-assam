        ...
        while (dxfLayerIterator.hasNext()) {
            ...
            if (dimensions != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    LOG.info
("Layer = " + dxfLayer.getName());
                    LOG.info
("Reference point = " + dimension.getReferencePoint());
                    LOG.info
("Reference point 3 = " + dimension.getReferencePoint3());
                    LOG.info
("Reference point 4 = " + dimension.getReferencePoint4());
                    LOG.info
("Reference point 5 = " + dimension.getReferencePoint5());
                    LOG.info
("Reference point 6 = " + dimension.getReferencePoint6());
                    LOG.info
("Dimension rotation = " + dimension.getDimensionRotation());
                    LOG.info
("Dimension Bounds = " + "Max x = " + dimension.getBounds().getMaximumX()
                            + ", Max y = " + dimension.getBounds().getMaximumY());
                    LOG.info
("Dimension Bounds = " + "Min x = " + dimension.getBounds().getMinimumX()
                    ...
                    for (DXFLine line : lines) {
                    	LOG.info
("Line start point  = " + line.getLength() + ", " + line.getStartPoint()
