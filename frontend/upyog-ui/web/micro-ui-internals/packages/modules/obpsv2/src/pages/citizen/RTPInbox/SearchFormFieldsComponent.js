    ...
    if (!isMobile) {
        return <React.Fragment>
            <div className="search-container" style={{  width : "100%" , marginLeft: "24px" }}>
                <div className="search-complaint-container" style= {{width : "100%", marginBottom : "16px"}}>
                    <div className="complaint-input-container" style={window.location.href.includes("/citizen") ? gridStyles() : { textAlign: "start" }}>
                        <SearchField>
                            <label>{t("OBPS_APPLICATION_NUMBER_LABEL")}</label>
                            <TextInput style={{"width": "300px"}} name="applicationNo" inputRef={registerRef({})} />
                        </SearchField>
